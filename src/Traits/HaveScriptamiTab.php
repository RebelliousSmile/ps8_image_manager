...
namespace ScImageManager\Traits;
...
trait HaveScriptamiTab
{
    ...
    private array $moduleTabNames = [
        'en' => 'Image Manager',
        'fr' => 'Gestionnaire Images',
    ];

    /**
     * Class name of this module's admin controller
     */
    private string $moduleControllerClass = 'AdminScImageManager';
    ...
    private function createChildTab(): bool
    {
        ...
        $tab->name = $tabNameByLangId;
        $tab->active = true;
        $tab->wording = 'Image Manager';
        $tab->wording_domain = 'Modules.Scimagemanager.Admin';
